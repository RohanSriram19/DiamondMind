...
import { predictSwing } from "../api";

// 15 features (as per your backend)
export default function SwingPredictor() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await predictSwing(numericFeatures);
      setResult(res.data.swing_probability);
    } catch (err) {
  ...
  return (
    <div className="p-4 max-w-lg mx-auto bg-white rounded-xl shadow mt-8">
      <h2 className="font-bold text-lg mb-2">Swing Probability Predictor</h2>
