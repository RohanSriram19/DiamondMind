...
export default function SwingProbabilityPredictor() {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await axios.post("http://127.0.0.1:5000/predict/swing", {
      features: featureArray,
    });
    setPrediction(response.data.swing_probability);
  };
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-3 text-yellow-300 drop-shadow">Swing Probability Predictor</h2>
